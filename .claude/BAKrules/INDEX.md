...
Everything in Ship is a document. Issues, projects, sprints, wikis - all stored in a single `documents` table with a `document_type` discriminator. See [Data Model](data-model.md).

...
describe('Accountability Service', () => {
  ...
  describe.skip('standup type (disabled — notifications scoped to plans/retros only)', () => {
  ...
  describe.skip('week_start type (disabled — notifications scoped to plans/retros only)', () => {
  ...
  describe.skip('week_issues type (disabled — notifications scoped to plans/retros only)', () => {
  ...
  describe.skip('project_retro type (disabled — notifications scoped to plans/retros only)', () => {
  ...
  describe.skip('weekly_review type (disabled — notifications scoped to plans/retros only)', () => {

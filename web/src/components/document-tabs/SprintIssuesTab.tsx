      ...
      <IssuesList
        ...
        emptyState={
          <div className="text-center py-12">
            ...
            <p className="text-sm font-medium text-muted">No issues in this sprint</p>
            <p className="text-xs text-muted mt-1">Issues assigned to this sprint will appear here</p>
          </div>
        }
      />
    </div>
